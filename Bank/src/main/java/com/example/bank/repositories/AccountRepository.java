...
import static com.example.bank.repositories.SQL.*;
...
public class AccountRepository {
    ...
    public boolean deposit(String acctId, Float amount) {
        ...
        int updateCount = template.update(SQL_UPDATE_ACCOUNT_BY_ACCT_ID, amount + acct.getBalance(), acctId);
    ...
    public boolean withdraw(String acctId, Float amount) {
        ...
        Account acct = opt.get();
        int updateCount = template.update(SQL_UPDATE_ACCOUNT_BY_ACCT_ID, acct.getBalance() - amount, acctId);
        return updateCount > 0;
    }
